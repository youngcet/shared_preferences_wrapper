...
class SharedPreferencesWrapperCacheManager {
  ...
  static Future<void> cacheData(
    ...
    await SharedPreferencesWrapper.addMap('$_keyData.$key',
        {key: data, _expirationTime: expirationTime.toIso8601String()});
  }
  ...
  static Future<dynamic> getCachedData(String key) async {
    String? data =
        await SharedPreferencesWrapper.getMapKey('$_keyData.$key', key);
    String? expirationTimeStr = await SharedPreferencesWrapper.getMapKey(
        '$_keyData.$key', _expirationTime);
    ...
    if (expirationTime.isAfter(DateTime.now())) {
      ...
      await SharedPreferencesWrapper.removeMapKey(
          '$_keyData.$key', _expirationTime);
      return null;
    }
  }
